...
- `\documentclass`：用于指定文档的基本类型；
- `\usepackage`：用于加载宏包，以扩展 $\LaTeX$ 的功能；
- `\title`、`\author`、`\date`：用于定义文档的基本元信息；
- `\maketitle`：用于在正文中生成标题页。

接下来，我们将按照功能逐一介绍这些命令的使用方法。

### 定义文档的基本类型

在专业文档排版中，常用的文档类包括 `article`、`report`、`book` 以及学术期刊所提供的定制类（如 IEEEtran、acmart 等）。选择合适的文档类是排版质量的第一步。
例如：
