...
在 $\LaTeX$ 语言中，文档可设置的元信息取决于其采用的排版类型。例如，就之前提到的`article`、`report`、`book`等文档类而言，它们可设置的元信息主要包括标题、作者、日期。这些信息通常会显示在文档的标题页中，以便读者了解文档的基本信息。它们分别可通过`\title`、`\author`、`\date`等命令进行设置。例如，如果我们想撰写一篇关于“LaTeX 排版快速入门”的文档，那么可以这样设置文档元信息：
