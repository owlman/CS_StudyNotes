...
同样的，读者现在暂时也不用担心看不懂`hello_latex.tex`文件中所用到的这些 $\LaTeX$ 标记，因为我稍后也会在《[[LaTeX学习笔记：文档排版基础]]》这篇笔记中开专题介绍这些标记，目前只需知道如何搭建 $\LaTeX$ 的中文排版环境即可。

## 笔记小结

通过本篇笔记的学习，我们已经对 $\LaTeX$ 标记的基本写法及其在第三方文档编辑器（如 Word、Markdown）和专业排版软件（如 CTeX 套装）中的使用方式有了一个初步的了解。接下来，我们将会在后续的笔记中深入探讨 $\LaTeX$ 的数学公式编辑和文档排版基础，以帮助大家更好地掌握这一强大的排版工具。
