...
或许对许多人来说，有些反直觉的是，$\LaTeX$ 被使用得最广泛的场景，并不是在专门用于学术排版的系统中，而是以公式编辑功能的形式，嵌入在 Word、Markdown 等第三方文档编辑器之中。下面，让我们从最简单的情况开始，先分别介绍一下 $\LaTeX$ 标记在 Word 与 Markdown 文档中的具体用法。
...
1. 在网页浏览器中打开 CTeX 套件在[清华大学的镜像站](https://mirrors.tuna.tsinghua.edu.cn/ctex/legacy/)。[^1]
...
[^1]:CTeX的官方网站已经停止维护多年，但我们可以通过它在国内的各种镜像站点下载到CTeX套装。
