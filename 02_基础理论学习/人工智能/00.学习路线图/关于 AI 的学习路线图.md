...
> - [[LLM 的微调实验]]：在这篇笔记中，我会介绍如何通过 LLaMA-Factory 在本地实现一次 LLM 的微调实验，并基于该实验结果分析 LLM 在 AI 系统中的角色。[博客园链接](https://www.cnblogs.com/owlman/p/22806036)
>
> **⏱ 时间预算与掌握标志**：
>
...
在这一阶段，我会建议先掌握一到两种不同形态的 AI Agent 应用，然后根据自身条件来选择以下路径之一，来完成一次面向具体问题的应用实践：

- 基于 OpenClaw、Hermes Agent 这类可远端部署的 AI Agent 提升个人或团队的工作效率。
- 基于 OpenCode、Pi Agent 这类本地运行的 AI Agent 完成一个中小型应用的开发与重构；
...
>
> - Vibe Coding 实践笔记：
>   - [[基于现有代码的重构实践]]：在这篇笔记中，我会使用 OpenCode 演示如何实现针对一个旧有程序的重构，并分享一些个人经验。（未完成）
>   - [[基于特定需求的开发实践]]：在这篇笔记中，我会使用 OpenCode 演示如何完成 Android 应用的开发，并分享一些个人经验。（未完成）
>
> **⏱ 时间预算与掌握标志**：
>
