...
> [!NOTE] 笔记说明
>
> 这篇笔记是《[[Agent 的能力体系]]》这一笔记的后续。其中记录了我学习如何为 Agent 应用构建记忆机制（包括 RAG 架构、长上下文窗口），并将其运用于不同 Agent 应用及其工作场景的实践经验与心得体会。同样的，这些内容也将作为我 Agent 系列笔记的一部分，被存储在本人 Github 上的[计算机学习笔记库](https://github.com/owlman/CS_StudyNotes)中，并予以长期维护。
